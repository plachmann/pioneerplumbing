...
function construction_landing_page_customizer_demo_content( $wp_customize ) {
	...
	$theme_demo_content_desc .= '<span class="sticky_info_row download-link"><label class="row-element">' . __( 'Download Demo Content Zip File', 'construction-landing-page' ) . ': </label><a href="' . esc_url( 'https://raratheme-wbtneb0y4p.netdna-ssl.com/wp-content/uploads/2017/12/construction-landing-page-demo-content.zip' ) . '" target="_blank">' . __( 'here', 'construction-landing-page' ) . '</a></span><br />';
