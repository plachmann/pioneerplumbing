...
add_filter( 'plumberpro_wrap_base', 'plumberpro_wrap_base_cpts' );
 ...
 */
function plumberpro_template_path() {
 ...
 */
function plumberpro_template_base() {
...
if ( ! class_exists( '__Tm_Wrapping' ) ) {
	...
	class __Tm_Wrapping {
		...
		public function __toString() {
			$this->templates = apply_filters( 'plumberpro_wrap_' . $this->slug, $this->templates );
 ...
 */
function plumberpro_wrap_base_cpts( $templates ) {
