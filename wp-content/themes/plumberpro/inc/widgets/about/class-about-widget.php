...
if ( ! class_exists( '__Tm_About_Widget' ) ) {
	...
	class __Tm_About_Widget extends Cherry_Abstract_Widget {
		...
		public function __construct() {
			...
			$this->widget_description = esc_html__( 'Display an information about your site.', 'plumberpro' );
			$this->widget_id          = 'plumberpro_widget_about';
			$this->widget_name        = esc_html__( 'About Plumberpro', 'plumberpro' );
			$this->settings           = array(
				'title'  => array(
					'type'  => 'text',
					'value' => '',
				...
				'media_id' => array(
					...
					'value'              => '',
					'label'              => esc_html__( 'Logo:', 'plumberpro' ),
				),
				'enable_tagline' => array(
					...
					'options' => array(
						'enable_tagline' => esc_html__( 'Enable Tagline:', 'plumberpro' ),
					),
				),
				'content'  => array(
					'type'              => 'textarea',
					'placeholder'       => esc_html__( 'Text or HTML', 'plumberpro' ),
					'value'             => '',
					'label'             => esc_html__( 'Content:', 'plumberpro' ),
		...
		public function widget( $args, $instance ) {
			...
			if ( $tagline_enabled ) {
				$format   = apply_filters( 'plumberpro_about_widget_tagline_format', '<p>%s</p>', $this->settings, $this->args );
...
add_action( 'widgets_init', 'plumberpro_register_about_widget' );
function plumberpro_register_about_widget() {
