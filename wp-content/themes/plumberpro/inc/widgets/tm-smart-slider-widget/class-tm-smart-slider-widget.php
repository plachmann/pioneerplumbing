...
class __Tm_Smart_Slider_Widget extends Cherry_Abstract_Widget {
	...
	public function __construct() {
		$this->widget_cssclass    = 'plumberpro widget_smart_slider';
		$this->widget_description = esc_html__( 'Display smart slider on your site.', 'plumberpro' );
		$this->widget_id          = 'widget_smart_slider';
		$this->widget_name        = esc_html__( 'Smart Slider Widget', 'plumberpro' );
		$this->settings           = array(
			'title' => array(
				'type'  => 'text',
				'value' => esc_html__( 'Smart Slider', 'plumberpro' ),
			...
			'posts_per_page' => array(
				...
				'max_value' => 50,
				'min_value' => 1,
				'label'     => esc_html__( 'Posts count', 'plumberpro' ),
			),
			'post_title' => array(
				'type'  => 'switcher',
				'value' => 'true',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Display title', 'plumberpro' ),
			),
			'content' => array(
				'type'  => 'switcher',
				'value' => 'false',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Display content', 'plumberpro' ),
			),
			'more_button' => array(
				'type'  => 'switcher',
				'value' => 'true',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Display more button', 'plumberpro' ),
			),
			'more_button_text' => array(
				'type'  => 'text',
				'value' => esc_html__( 'Read more', 'plumberpro' ),
				'label' => esc_html__( 'More button text', 'plumberpro' ),
			),
			'trim_words' => array(
				'type'       => 'slider',
				'value'      => 15,
				...
				'min_value'  => 1,
				'step_value' => 1,
				'label'      => esc_html__( 'Content words trimmed count', 'plumberpro' ),
			),
			'width' => array(
				'type'  => 'text',
				'value' => '100%',
				'label' => esc_html__( 'Slider width', 'plumberpro' ),
			),
			'height' => array(
				'type'  => 'text',
				'value' => '800',
				'label' => esc_html__( 'Slider height', 'plumberpro' ),
			),
			'orientation' => array(
				'type'    => 'select',
				'size'    => 1,
				'value'   => 'horizontal',
				'options' => array(
					'horizontal' => esc_html__( 'Horizontal', 'plumberpro' ),
					'vertical'   => esc_html__( 'Vertical', 'plumberpro' ),
				),
				'label' => esc_html__( 'Slider orientation', 'plumberpro' ),
			),
			'slide_distance' => array(
				...
				'max_value' => 100,
				'min_value' => 0,
				'label'     => esc_html__( 'Slide distance(px)', 'plumberpro' ),
			),
			'slide_duration' => array(
				...
				'min_value'  => 100,
				'step_value' => 100,
				'label'      => esc_html__( 'Slide duration(ms)', 'plumberpro' ),
			),
			'slide_fade' => array(
				'type'  => 'switcher',
				'value' => 'false',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Use fade effect?', 'plumberpro' ),
			),
			'navigation' => array(
				'type'  => 'switcher',
				'value' => 'true',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Use navigation?', 'plumberpro' ),
			),
			'fade_navigation' => array(
				'type'  => 'switcher',
				'value' => 'true',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Indicates whether the arrows will fade in only on hover', 'plumberpro' ),
			),
			'pagination' => array(
				'type'  => 'switcher',
				'value' => 'true',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Use pagination?', 'plumberpro' ),
			),
			'autoplay' => array(
				'type'  => 'switcher',
				'value' => 'true',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Use autoplay?', 'plumberpro' ),
			),
			'fullScreen' => array(
				'type'  => 'switcher',
				'value' => 'false',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Display fullScreen button?', 'plumberpro' ),
			),
			'shuffle' => array(
				'type'  => 'switcher',
				'value' => 'false',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Indicates if the slides will be shuffled', 'plumberpro' ),
			),
			'loop' => array(
				'type'  => 'switcher',
				'value' => 'true',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Use infinite scrolling?', 'plumberpro' ),
			),
			'thumbnails' => array(
				'type'  => 'switcher',
				'value' => 'false',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Display thumbnails?', 'plumberpro' ),
			),
			'thumbnails_arrows' => array(
				'type'  => 'switcher',
				'value' => 'true',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Display thumbnails arrows?', 'plumberpro' ),
			),
			'thumbnails_position' => array(
				...
				'options' => array(
					...
					'bottom' => esc_html__( 'Bottom', 'plumberpro' ),
					'right'  => esc_html__( 'Right', 'plumberpro' ),
					'left'   => esc_html__( 'Left', 'plumberpro' ),
				),
				'label' => esc_html__( 'Sets the position of the thumbnail scroller', 'plumberpro' ),
			),
		);
	...
	public function widget( $args, $instance ) {
		...
		if ( $posts_query ) {
			...
			$html = '<h4>' . esc_html__( 'Posts for slider not found', 'plumberpro' ) . '</h4>';
		}
	...
	public function render_slider( $posts_query ) {
		...
		$html = '<div class="plumberpro-smartslider" ' . $slider_html_attr . '>';
			$html .= '<div id="' . $uniq_id . '" class="plumberpro-smartslider__instance slider-pro">';
				$html .= '<div class="plumberpro-smartslider__slides sp-slides">';
					$html .= $this->get_slider_loop( $posts_query );
				$html .= '</div>';

				if ( 'true' == $this->instance['thumbnails'] ) {
					$html .= '<div class="plumberpro-smartslider__thumbnails sp-thumbnails">';
	...
	public function get_query_slider_items( $query_args = array() ) {
		...
		$defaults_query_args = apply_filters( 'plumberpro_smart_slider_default_query_args', array(
			'post_type'      => 'post',
			'orderby'        => 'date',
			'order'          => 'DESC',
			'posts_per_page' => -1,
	...
	public function get_slider_loop( $posts_query ) {
		 ...
		 * @var  array
		 */
		$title_settings = apply_filters( 'plumberpro_smart_slider_title_settings', array(
		 ...
		 * @var  array
		 */
		$content_settings = apply_filters( 'plumberpro_smart_slider_content_settings', array(
		 ...
		 * @var  array
		 */
		$more_settings = apply_filters( 'plumberpro_smart_slider_more_button_settings', array(
		...
		$placeholder_args = apply_filters( 'plumberpro_smart_slider_placeholder_args', array(
			'width'  => 1600,
	...
	public function get_slider_thumbnails( $posts_query ) {
		...
		$thumbnail_size = apply_filters( 'plumberpro_smart_slider_thumbnail_size', 'plumberpro-thumb-240-100', $this->instance );
	...
	public function get_image( $id, $size, $placeholder_attr, $only_url = false ) {
		...
		if ( has_post_thumbnail( $id ) ) {
			...
			$default_placeholder_attr = apply_filters( 'plumberpro_smart_slider_placeholder_default_args', array(
				'width'      => 900,
				'height'     => 500,
				'background' => 'eef4fa',
				'foreground' => '298ffc',
...
add_action( 'widgets_init', 'plumberpro_register_smart_slider_widgets' );
function plumberpro_register_smart_slider_widgets() {
