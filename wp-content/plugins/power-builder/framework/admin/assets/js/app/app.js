					...
					if ( $mobile_fields.length ) {
						$mobile_fields.each( function() {
							var $this_field = $( this ),
								...
								new_default = 'tablet' === this_device ? $this_field.siblings( 'input[type="' + input_type + '"].tm_pb_setting_mobile_desktop' ).val() : $this_field.siblings( 'input[type="' + input_type + '"].tm_pb_setting_mobile_tablet' ).val();
