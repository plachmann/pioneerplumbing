...
<div class="booked-scrollable">
	...
	<form action="" method="post" class="booked-form" id="newAppointmentForm"<?php if ($calendar_id): echo ' data-calendar-id="'.$calendar_id.'"'; endif; ?>>
		...
		<div class="condition-block customer_type" id="condition-new">
			<div class="field">
				<input value="" placeholder="<?php _e('Name','booked'); ?> ..." type="text" class="large textfield" name="name" />
			</div>
			<div class="field">
				<input value="" placeholder="<?php _e('Email Address','booked'); ?> ..." type="email" class="textfield" name="email" />
				<input value="" placeholder="<?php _e('Choose a password','booked'); ?> ..." type="password" class="textfield" name="password" />
			</div>
		</div>
		...
		<?php if ($guest_booking): ?>
			...
			<div class="condition-block customer_type" id="condition-guest">
				<div class="field">
					<input value="" placeholder="<?php _e('Name','booked'); ?>" type="text" class="large textfield" name="guest_name" />
				</div>
				<div class="field">
					<input value="" placeholder="<?php _e('Email Address','booked'); ?>" type="email" class="large textfield" name="guest_email" />
				</div>
			</div>
...
<p class="booked-title-bar"><small><?php _e('New Appointment','booked'); ?></small></p>
